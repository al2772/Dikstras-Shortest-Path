...
public class GraphTest {
  ...
  /**
   * Test that the distance from start node to last node visited is correct
   */
  @Test
  ...
  /**
   * Test that the node path from the start node to the last node visited is correct
   */
  @Test
  ...
  /**
   * Test that path E to F has the proper cost after the path is taken
   */
  @Test
  ...
  /**
   * Test that the predecessor node on path C to E is correct
   */
  @Test
   ...
   */
  @Test
  public void testSmallShortestPath() {
